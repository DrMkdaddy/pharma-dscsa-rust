...
/// Client configuration for FDA DSCSA & EU FMD Drug Serialization API (21 USC 360eee).
#[derive(Debug, Clone)]
...
/// Main client for FDA DSCSA & EU FMD Drug Serialization API (21 USC 360eee).
pub struct PharmaDscsaClient {
    config: RapidApiConfig,
    client: Client,
}

impl PharmaDscsaClient {
